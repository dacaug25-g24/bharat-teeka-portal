                ...
                <div className="certificate-steps mb-4">
                    <div className="step-item">
                        ...
                        <div>
                            ...
                            <p className="small text-muted mb-0">Enter your registered details securely</p>
                        </div>
                    </div>
                    ...
                    <div className="step-item">
                        ...
                        <div>
                            ...
                            <p className="small text-muted mb-0">Check your records and ensure all details are correct</p>
                        </div>
                    </div>
                    ...
                    <div className="step-item">
                        ...
                        <div>
                            ...
                            <p className="small text-muted mb-0">Save the official certificate as a PDF</p>
                        </div>
                    </div>
                </div>
